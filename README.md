...
- **Technologies:** Node.js, MongoDB, JWT, Redis, Express
- **Description:** An SSO integration application enabling seamless authentication across multiple platforms.

### [Pointer Wallet](https://wallet.pointer.io.vn/)
- **Technologies:** React, Redux Toolkit, Tailwind CSS
- **Description:** A wallet management application featuring a user-friendly interface for handling transactions and balances.
